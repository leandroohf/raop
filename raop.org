...
*** DONE Ensemble
    ...
    [[file:scratch/2017-01-29-stack_gbm_depth2_ntree1700_auc0.832.png]]
   #+begin_src R
     ## ----------------------------------- [ Ensemble Stack  ]
...
** DONE Diagnostics
   ...
   *=================================*
   ...
   Permutation test. No final nao parece ser tao util pois dependendo
   do resultados do da analise exploratorio acho que nao faz sentido fazer.

   Ou fazer apenas bem simples com 7 intercaoes
